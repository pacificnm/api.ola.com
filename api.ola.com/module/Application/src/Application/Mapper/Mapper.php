...
abstract class Mapper implements MapperInterface
{
    ...
    {
        if ($this->debug) {
            echo $this->readSql->buildSqlString($this->select);
            die();
        }
    ...
    {
        if ($this->debug) {
            echo $this->writeSql->buildSqlString($this->insert);
            die();
        }
    ...
    protected function updateRow()
    {
        ...
        $this->update = new Update('auction');
    ...
    {
        if ($this->debug) {
            echo $this->writeSql->buildSqlString($this->delete);
            die();
        }
